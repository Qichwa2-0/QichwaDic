    ...
    Column(
        ...
        Column(
            ...
            Column(
                ...
                Button(onClick = sendContactMail, Modifier.fillMaxWidth()) {
                    Text(text = stringResource(R.string.about_contact))
                }
                Spacer(modifier = Modifier.width(10.dp))
                Button(onClick = openMarketIntent, Modifier.fillMaxWidth()) {
                    Text(text = stringResource(R.string.about_rate_app))
                }
                Spacer(modifier = Modifier.width(10.dp))
                Button(
